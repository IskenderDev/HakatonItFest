...
//       <div className="bg-white w-[420px] p-4 rounded shadow-lg">
//         <p className="text-lg font-bold mb-2">Parking Slot Information</p>
//         <p className="mb-4">Do you want to reserve this parking slot?</p>
...
//               <div className="w-[7px] h-[7px] bg-red-600 mb-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-red-600 mb-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-green-600 mb-[15px]" onClick={() => handleSlotClick()}></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-green-600 mb-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-red-600 mb-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-green-600 mb-[15px]"></div>
...
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-green-600 mt-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-green-600 mt-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-red-600 mt-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-red-600 mt-[15px]"></div>
//               <div className="w-[100px] h-[3px] bg-white -rotate-12"></div>
//               <div className="w-[7px] h-[7px] bg-green-600 mt-[15px]"></div>
